...
Define tournament stat leaderboards and derived statistics that can be rendered from static tournament data and deterministic client-side calculations.
## Requirements
